...
if (getLs) {
  ...
  if (itemList.length == 0) {
    ...
    getCount.innerHTML=itemList.length
  ...
  itemList.forEach((x) => {
    ...
    let newDiv = createNewItems(x.price, x.title, x.imgSrc);
...
async function item(id) {
  await fetch("./electricgadgets.json")
    .then((res) => res.json())
...
function createCart() {
  ...
  if (value !== "") {
    const objList = { title, price, imgSrc, qty: 1 };
    itemList.push(objList);

    const cartDown = document.querySelector('.appendDiv');
    const newDiv = createNewItems(price, title, imgSrc);
...
function LocalStorage() {
  let cartData = JSON.stringify(itemList);
  localStorage.setItem("cartStorage", cartData);
}
     ...
     <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="carsoual/gadgets.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="carsoual/Mensclothing.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="carsoual/womansclothing.jpeg" class="d-block w-100" alt="...">
          </div>
        </div>
